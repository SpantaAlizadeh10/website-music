...
const songs = [
  ...
  {
    id: "2",
    songName: `Ahmadzahir dostat darom
        <br>
        <div class="subtitle">Ahmad Zahir</div>`,
    poster: "images/ahmadzahir.jpg",
  },
...
const makeALLplays = () => {
  Array.from(document.getElementsByClassName("playlistplay")).forEach(
    (element) => {
      element.classList.add("bi-play-xircle-fill");
      element.classList.remove("bi-play-xircle-fill");
    }
  );
};
...
Array.from(document.getElementsByClassName("playlistplay")).forEach(
  (element) => {
    element.addEventListener("click", (e) => {
      index = e.target.id;
      makeALLplays();
      e.target.classList.remove("bi-play-xircle-fill");
      e.target.classList.add("bi-play-xircle-fill");
